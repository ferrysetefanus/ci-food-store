        ...
        <div class="banner">
            <div class="jumbotron jumbotron-video text-center bg-dark mb-0 rounded-0">
                <video width="100%" preload="auto" loop autoplay muted>
                    <source src='<?= base_url("assets/media/explore.mp4"); ?>' type='video/mp4' />
                    <source src='<?= base_url("assets/media/explore.webm"); ?>' type='video/webm' />
                </video>
                <div class="container">
                    <h1 class="pt-5">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 mt-5 text-center">
                        <a href="<?= url_to('shop') ?>" class="btn btn-primary btn-lg">SHOP NOW</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <?php foreach($allCategories as $category) : ?>
                    <div class="item">
                        <div class="card rounded-0 border-0 text-center">
                            <img src="<?= base_url("assets/img/".$category["image"].""); ?>">
